...
public class TaskCompletionViolation {
    ...
    public static void main(String[] args) {
        new TaskCompletionViolation();
    }

    private TaskCompletionViolation() {
        ...
        System.out.println("IDs of tasks that violate the SLA Task Completion Parameter:");
        finishedCloudlets.forEach((c)->{
        	double time = c.getFinishTime()-c.getExecStartTime() - c.getWaitingTime();
        	double threshold = contract.getTaskCompletionTimeMetric().getMaxDimension().getValue()/1000.0;
        	if(time >threshold) {
