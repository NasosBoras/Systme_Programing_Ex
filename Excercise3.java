...
public class Excercise3 {
    ...
    private List<Cloudlet> createCloudlets() {
        ...
        NormalDistribution normalDistributionForDelay = new NormalDistribution(8,4);
        NormalDistribution normalDistributionForLenght = new NormalDistribution((double)CLOUDLET_LENGTH,200);
